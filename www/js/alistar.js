...
var app = {
            ...
            swal({
                ...
                .then((Quitar) => {
                    ...
                    if (Quitar) {
                        ...
                        $.when(app.eliminarItem(iditem, req)).done(function () {
    ...
    eliminarItem: function(iditem, req) {
